...
function EmployeeFormModal({ isOpen, onClose, employee }: {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (employee) {
      updateEmployee(employee.id, { ...form, phone: form.phone || undefined });
    } else {
      addEmployee({ ...form, phone: form.phone || undefined });
    }
    onClose();
  };
...
export function EmployeesManager() {
  ...
  return (
    <div className="p-4 md:p-6 max-w-4xl mx-auto">
      ...
      {active.length > 0 && (
        <div className="mb-6">
          <p className="text-xs text-gray-500 uppercase tracking-wider font-medium mb-3">Ativos</p>
